...
public class QRating extends EntityPathBase<Rating> {
    ...
    private static final long serialVersionUID = 884875829L;
    ...
    public QRating(Class<? extends Rating> type, PathMetadata metadata, PathInits inits) {
        ...
        this.ratingWriter = inits.isInitialized("ratingWriter") ? new QUser(forProperty("ratingWriter"), inits.get("ratingWriter")) : null;
    }
